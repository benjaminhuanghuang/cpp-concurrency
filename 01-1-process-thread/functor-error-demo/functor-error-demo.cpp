...
int main()
{
    ...
    /*
     ambiguous, since it could be interpreted either as
      ...
      2. a function declaration for a function t that returns an object of type std::thread and has a single (unnamed) parameter 
         that is a pointer to function returning an object of type Vehicle
    */
